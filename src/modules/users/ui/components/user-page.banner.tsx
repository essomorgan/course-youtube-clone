...
export const UserPageBannerSkeleton = () => {
	return <Skeleton className='w-full max-h-[200px] h-[15vh] md:h-[25vh] bg-gradient-to-r from-gray-100 to-gray-200 rounded-xl' />;
};
...
export const UserPageBanner = ({ user }: UserPageBannerProps) => {
	...
	return (
		<div className='relative group'>
			<BannerUploadModal userId={user.id} open={isModalOpen} onOpenChange={setIsModalOpen} />
			<div
				className={cn(
