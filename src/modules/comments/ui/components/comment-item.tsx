				...
				<div className='flex-1 min-w-0'>
					<Link href={`/users/${comment.userId}`}>
						<div className='flex items-center gap-2 mb-0.5'>
							...
							<span className='text-xs text-muted-foreground'>{formatDistanceToNow(comment.createAt, { addSuffix: true })}</span>
						</div>
					</Link>
					...
					<div className='flex items-center gap-2 mt-1'>
						<div className='flex items-center'>
							...
							<span className='text-xs text-muted-foreground'>{comment.likeCount || 0}</span>
							<Button
							...
							<span className='text-xs text-muted-foreground'>{comment.dislikeCount || 0}</span>
						</div>
						{variant === 'comment' && (
